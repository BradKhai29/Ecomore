        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsVerifiedToUpload = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BlogEntity_SystemAccounts_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "SystemAccounts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BlogEntity_SystemAccounts_VerifiedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SystemAccountTokens_TokenTypes_TokenTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransactionCode = table.Column<string>(type: "VARCHAR(200)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogEntity_CreatedBy",
                table: "BlogEntity",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_BlogEntity_VerifiedBy",
                table: "BlogEntity",
                column: "VerifiedBy");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SystemAccountTokens_TokenTypeId",
                table: "SystemAccountTokens",
                column: "TokenTypeId");
